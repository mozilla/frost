...
def rds_db_snapshots_attributes():
    ...
    return [botocore_client\
      .get(service_name='rds',
           ...
           result_from_error= lambda e, call: {'DBSnapshotAttributesResult':
                                    {'DBSnapshotAttributes': []}},  # treat not found as empty list
           )\
